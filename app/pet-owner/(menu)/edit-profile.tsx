...
const EditProfile = () => {
  const { userId, setUserFirstName, setUserLastName, setUserImagePath } =
    useAppContext();
  ...
  const [profile, setProfile] = useState<any>({
    ...
    // isOpen: params.isOpen === "true" || false,
                  ...
                  <View style={styles.openStatusContainer}>
                    ...
                    <Pressable
                      style={[
                        styles.statusToggle,
                        {
                          backgroundColor: profile.isOpen
                            ? "#4CAF50"
                            : "#E53935",
                        },
                      ]}
                    ...
                    <Text
                      style={[
                        styles.statusText,
                        { color: profile.isOpen ? "#4CAF50" : "#E53935" },
                      ]}
                    >
